    ...
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'markets': {
                ...
                'BCHABC/IDR': { 'id': 'bchabc_idr', 'symbol': 'BCHABC/IDR', 'base': 'BCHABC', 'quote': 'IDR', 'baseId': 'bchabc', 'quoteId': 'idr', 'precision': { 'amount': 8, 'price': 0 }, 'limits': { 'amount': { 'min': 0.001, 'max': undefined }}},
                'BCHSV/IDR': { 'id': 'bchsv_idr', 'symbol': 'BCHSV/IDR', 'base': 'BCHSV', 'quote': 'IDR', 'baseId': 'bchsv', 'quoteId': 'idr', 'precision': { 'amount': 8, 'price': 0 }, 'limits': { 'amount': { 'min': 0.001, 'max': undefined }}},
